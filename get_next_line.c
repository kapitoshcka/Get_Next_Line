...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/12/12 15:37:05 by fkarnats          #+#    #+#             */
/*   Updated: 2018/12/12 15:37:20 by fkarnats         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** 3) add end of line to it, now buf has end of line charcter after \n
...
** 4) allocate memory with 32 size
...
** with  diffrent  file  descriptors,  it will always returns the next line.
**
**
